  ...
  return (
    <div style={{ padding: '20px' }}>
        ...
        <div>
          ...
          <div style={{ 
            ...
            <div style={{ background: '#f8f9fa', padding: '15px', borderRadius: '5px' }}>
              <h4>Статистика</h4>
              <div>Всего записей: <strong>{realTimeData.count}</strong></div>
              <div>ID 0: <span style={{ 
            ...
            <div style={{ background: '#f8f9fa', padding: '15px', borderRadius: '5px' }}>
              ...
              <div style={{ 
                ...
                {realTimeData.ids.map(id => (
                  <span key={id} style={{ 
                    background: id === '0' || id === '31' ? '#ffcccc' : '#d4edda',
                    padding: '5px 10px',
                    borderRadius: '3px',
                    fontSize: '14px'
                  }}>
      ...
      <div style={{ 
        ...
        <ol>
          <li><strong>Chrome/Firefox:</strong> Ctrl+Shift+R (жесткая перезагрузка)</li>
          <li><strong>Открой DevTools (F12) → Network</strong></li>
          <li><strong>Поставь галочку "Disable cache"</strong></li>
          <li><strong>Обнови страницу</strong></li>
          <li><strong>Или открой в режиме инкогнито</strong> (Ctrl+Shift+N)</li>
        </ol>
      </div>
    </div>
  );
