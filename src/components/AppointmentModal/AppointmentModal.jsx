...
// // Массив доступных времен для встречи (цифровой формат)
// const timeSlots = [
...
//         {/* Информация о психологе с фото - ДАННЫЕ ИЗ КАРТОЧКИ */}
...
//           {/* Имя психолога ИЗ КАРТОЧКИ */}
//           <div className="psychologist-details">
//             {/* Поменяли местами: сначала "Your psychologist" */}
//             <p className="psychologist-title">
//               Your psychologist
//             </p>
//             {/* Затем имя из карточки */}
